...
<div class="col-lg-12">
    <div class="p-5">
        <div class="text-center">
            ...
            <h1 class="h1 text-gray-900 mb-4">Update sub Categorys</h1>
        </div>
        ...
        <input type="hidden" name="id" value="{{$subcategories->id}}"/>
            ...
            <div class="form-group">
                <label>Title</label>
                <input type="text" class="form-control form-control-user" name="title" value="{{$subcategories->title}}" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Title">
