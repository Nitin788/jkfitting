...
<div class="col-lg-12">
    <div class="p-5">
        ...
        <form class="user" action="{{route('update-blog')}}" method="POST">
            ...
            <div class="form-group">
                <label>Title</label>
                <input type="text" class="form-control form-control-user" value="{{$blog->title}}" name="title" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Title">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-user" value="{{$blog->discription}}" name="disc" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Discription">
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control form-control-user" value="{{$blog->photo}}" name="photo" placeholder="Choose Photo" />
            </div>
